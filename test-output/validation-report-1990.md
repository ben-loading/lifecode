...
| dimensionDetails[].level 枚举 | ✅ | S级, A级, B级, C级, D级 | B级, A级, B级, C级, A级, C级, B级 |
...
| lifeScriptTitle 格式 | ✅ | 四字·四字 | 禄存守命·水火激荡 |
| coreAbilityTags 格式 | ✅ | 全部以 # 开头 | #资源整合者, #稳健财主 |
...
| 2025 | 平/吉 | 凶 | false | false |
| 2026 | 凶 | 大凶（预警） | true | true |
